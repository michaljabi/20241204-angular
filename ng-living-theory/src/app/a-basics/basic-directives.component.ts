...
@Component({
  ...
  template: `
    ...
    <div class="box">
      ...
      <ng-container [ngSwitch]="optionNumber">
        <span *ngSwitchCase="'one'"> 🍌 </span>
        <span *ngSwitchCase="'two'"> 🍌🍌 </span>
        <span *ngSwitchCase="'tree'"> 🍌🍌🍌 </span>
